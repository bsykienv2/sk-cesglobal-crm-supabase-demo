...
function SaveButton() {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="px-8 py-2 rounded-full font-bold text-ivory bg-terracotta ring-1 ring-terracotta hover:opacity-90 transition-all shadow-md hover:-translate-y-0.5 text-[15px] disabled:opacity-60"
    >
...
export function GlobalInteractionModal({
  leads,
}: {
  ...
  return (
    <>
      <button
        ...
        className="px-6 py-2.5 bg-terracotta text-ivory rounded-full text-[15px] font-bold shadow-md hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 transition-all flex items-center gap-2"
      >
            ...
            >
              ...
              <div className="p-6 space-y-6">
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            ...
                            active
                              ? "border-terracotta bg-parchment ring-1 ring-terracotta shadow-sm"
                ...
                <div className="space-y-2">
                  ...
                  <select
                    name="lead_id"
                    required
                    className="w-full bg-white border border-border-warm rounded-lg text-near-black focus:ring-2 focus:ring-focus-blue focus:border-transparent p-3 text-sm outline-none transition-all"
                  >
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    name="title"
                    required
                    placeholder="Ví dụ: Demo Online, Khảo sát..."
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    name="content"
                    rows={3}
                    placeholder="Nhập chi tiết lịch trình lúc gặp..."
                ...
                <div className="flex gap-4">
                  <div className="flex-1 space-y-2">
                    <label className="block text-[10px] uppercase font-bold tracking-widest text-stone-gray">
                      Thời điểm
                    </label>
                    <input
                      type="datetime-local"
                      ...
                      className="w-full bg-parchment border-none rounded-full py-2 px-4 text-xs font-semibold ring-1 ring-border-warm"
                    />
                  </div>
                  <div className="flex-1 space-y-2">
                    <label className="block text-[10px] uppercase font-bold tracking-widest text-stone-gray">
                ...
                {state.error ? (
                  <div className="flex items-start gap-2 px-4 py-3 bg-[#fdf2f2] text-error-crimson rounded-lg border border-[#fbd5d5] text-sm font-medium">
              ...
              <div className="px-6 py-4 bg-parchment flex items-center justify-end gap-3 border-t border-border-cream mt-auto">
                <button
                  type="button"
                  onClick={() => setOpen(false)}
                  className="px-6 py-2 rounded-full font-bold text-charcoal-warm bg-transparent hover:bg-warm-sand transition-all text-sm"
                >
                  Hủy
                </button>
                <SaveButton />
